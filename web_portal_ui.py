...
PORTAL_CSS = (
    ...
    '.upgrade-overall{margin:13px 0;padding:13px 15px;border:1px solid var(--line);'
    'border-radius:10px;background:var(--soft)}.upgrade-overall[hidden]{display:none}'
    ...
    'transition:width .18s ease}.upgrade-stage-list{display:grid;gap:5px;margin:0;padding:0;list-style:none;'
    'font-size:.82rem}.upgrade-stage-list li{display:flex;align-items:center;gap:8px;color:var(--muted)}'
    '.upgrade-stage-list li:before{content:"";width:.62rem;height:.62rem;flex:0 0 auto;border:2px solid '
    'var(--line);border-radius:50%;background:var(--surface)}.upgrade-stage-list li.active{color:var(--ink);'
