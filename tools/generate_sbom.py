#!/usr/bin/env python3
"""Generate a deterministic CycloneDX SBOM for an IoT-MD release source tree."""
...
def build_sbom(root, version):
    ...
    components.extend((
        ...
        {
            'type': 'library', 'name': 'IoT-MD native cryptography',
            'version': str(version),
    ...
    return {
        ...
        'version': 1,
        'metadata': {'component': {
            'type': 'firmware', 'name': 'IoT-MD', 'version': str(version)
        }},
