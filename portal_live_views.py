...
def update_upload_script():
    return (
        ...
        'if(!r.ok)throw new Error("Unable to read component progress");return r.json();}).then(function(s){label.textContent='
        '"Verifying "+kind+" "+(s.percent||0)+"%";if(s.phase==="complete")'
