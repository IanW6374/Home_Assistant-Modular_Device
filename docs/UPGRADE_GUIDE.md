...
`2.3.8` and release sequence `2508`:

```sh
python3 tools/build_update.py releases/v2.3.8/application-2.3.8.iotapp \
  --version 2.3.8 --release-sequence 2508 \
...
python3 tools/build_micropython_firmware.py \
  ...
  --version 2.3.8 --release-sequence 2508 \
  --output releases/v2.3.8/iotmd-core-2.3.8.iotcore \
  --factory-output /secure-output/iotmd-core-2.3.8.factory.bin \
...
python3 tools/build_universal_update.py \
  releases/v2.3.8/universal-2.3.8.iotuni \
  --application releases/v2.3.8/application-2.3.8.iotapp \
  --firmware releases/v2.3.8/iotmd-core-2.3.8.iotcore \
  --version 2.3.8 --release-sequence 2508 \
  --signing-key /secure/update.signing-key
```
