...
`2.2.7` and release sequence `2407`:

```sh
python3 tools/build_update.py releases/v2.2.7/application-2.2.7.iotapp \
  --version 2.2.7 --release-sequence 2407 \
...
python3 tools/build_micropython_firmware.py \
  ...
  --version 2.2.7 --release-sequence 2407 \
  --output releases/v2.2.7/iotmd-core-2.2.7.iotcore \
  --factory-output /secure-output/iotmd-core-2.2.7.factory.bin \
...
python3 tools/build_universal_update.py \
  releases/v2.2.7/universal-2.2.7.iotuni \
  --application releases/v2.2.7/application-2.2.7.iotapp \
  --firmware releases/v2.2.7/iotmd-core-2.2.7.iotcore \
  --version 2.2.7 --release-sequence 2407 \
  --signing-key /secure/update.signing-key
```
...
python3 tools/reseed_device_usb.py \
  ...
  --bundle releases/v2.2.7/iotmd-core-2.2.7.iotcore \
  --application-bundle releases/v2.2.7/application-2.2.7.iotapp \
  --micropython-root /path/to/micropython \
