...
`2.2.8` and release sequence `2408`:

```sh
python3 tools/build_update.py releases/v2.2.8/application-2.2.8.iotapp \
  --version 2.2.8 --release-sequence 2408 \
...
python3 tools/build_micropython_firmware.py \
  ...
  --version 2.2.8 --release-sequence 2408 \
  --output releases/v2.2.8/iotmd-core-2.2.8.iotcore \
  --factory-output /secure-output/iotmd-core-2.2.8.factory.bin \
...
python3 tools/build_universal_update.py \
  releases/v2.2.8/universal-2.2.8.iotuni \
  --application releases/v2.2.8/application-2.2.8.iotapp \
  --firmware releases/v2.2.8/iotmd-core-2.2.8.iotcore \
  --version 2.2.8 --release-sequence 2408 \
  --signing-key /secure/update.signing-key
```
...
python3 tools/reseed_device_usb.py \
  ...
  --bundle releases/v2.2.8/iotmd-core-2.2.8.iotcore \
  --application-bundle releases/v2.2.8/application-2.2.8.iotapp \
  --micropython-root /path/to/micropython \
