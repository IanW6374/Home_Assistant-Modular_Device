...
`2.2.9` and release sequence `2409`:

```sh
python3 tools/build_update.py releases/v2.2.9/application-2.2.9.iotapp \
  --version 2.2.9 --release-sequence 2409 \
...
python3 tools/build_micropython_firmware.py \
  ...
  --version 2.2.9 --release-sequence 2409 \
  --output releases/v2.2.9/iotmd-core-2.2.9.iotcore \
  --factory-output /secure-output/iotmd-core-2.2.9.factory.bin \
...
python3 tools/build_universal_update.py \
  releases/v2.2.9/universal-2.2.9.iotuni \
  --application releases/v2.2.9/application-2.2.9.iotapp \
  --firmware releases/v2.2.9/iotmd-core-2.2.9.iotcore \
  --version 2.2.9 --release-sequence 2409 \
  --signing-key /secure/update.signing-key
```
